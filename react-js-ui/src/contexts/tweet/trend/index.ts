...
type ContextType = {
  ...
  dispatch: React.Dispatch<Action.WithPayload<any | Topic.Response[]>>;
};
...
const reducer = (state = init, action: Action.WithPayload<any | string | number | Topic.Response[]>) => {
  switch (action.type) {
    case Types.LOAD:
...
export { store, reducer, Topic, init, Actions };
