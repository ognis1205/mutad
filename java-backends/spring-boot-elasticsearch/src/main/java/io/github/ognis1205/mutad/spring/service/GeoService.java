...
public interface GeoService {
     ...
     */
    public List<Geo> getByHashtags(Date from, Date to, String text, List<String> hashtags);
     ...
     * @return the `Geo` instances match the query condition.
     */
    public List<Geo> getByGeolocation(Date from, Date to, String text, List<String> hashtags, GeoPoint center, String radius);
}
