 ...
 * @version 1.0.0
 */
public interface EsGeoRepository {
    /**
     * Finds all goe documents in 'geo' index which have selected hashtags
     ...
     */
    public List<Geo> findByHashtags(Date from, Date to, String text, List<String> hashtags);

    /**
     * Finds all geo documents in 'geo' index which have selected hashtags
     ...
     * @return the `Geo` instances match the query condition.
     */
    public List<Geo> findByGeolocation(Date from, Date to, String text, List<String> hashtags, GeoPoint center, String radius);
}
